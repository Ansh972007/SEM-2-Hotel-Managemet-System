...
public class Reception extends JFrame {
	...
	public Reception(){
		...
		JButton foodOrderButton = new JButton("Food Ordering");
		foodOrderButton.setBounds(10, 470, 200, 30);
		foodOrderButton.setBackground(Color.BLACK);
		foodOrderButton.setForeground(Color.WHITE);
		foodOrderButton.addActionListener(e -> {
			new FoodOrderSystem(); // This opens your food ordering screen
		});
		add(foodOrderButton);
		...
		ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Hotel1/Reception.jpg"));
		Image i3 = i1.getImage().getScaledInstance(1700, 900,Image.SCALE_DEFAULT);
		ImageIcon i2 = new ImageIcon(i3);
		JLabel l1 = new JLabel(i2);
		l1.setBounds(-150,-100,1920,1080);
		add(l1);
