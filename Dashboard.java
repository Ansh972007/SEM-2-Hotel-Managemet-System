...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Hotel1/Dashbord.jpg"));
        Image i2 = i1.getImage().getScaledInstance(1800, 800,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(-190, -170, 1720, 1080);
        add(NewLabel);
        
        JLabel AirlineManagementSystem = new JLabel("THE TAJ GROUP WELCOMES YOU");
	AirlineManagementSystem.setForeground(new Color(51,0,25));
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.PLAIN, 46));
	AirlineManagementSystem.setBounds(600, 200, 1000, 85);
